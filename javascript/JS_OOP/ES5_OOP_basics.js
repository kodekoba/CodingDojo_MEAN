...
//tests
//console.log(myCarInstance.updateOdometer(1000).readOdometer()); // This won't run because updateOdometer() is scoped to the constructor, therefor the function is private
